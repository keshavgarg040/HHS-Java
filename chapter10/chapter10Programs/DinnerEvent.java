...
class DinnerEvent extends Event {
    public final static String[] ENTREES = { "dumplings", "sliders", "meatballs", "asparagus" };
    public final static String[] SIDES = { "salad", "mixed vegetables", "pasta", "garlic bread", "roll" };
    public final static String[] DESSERTS = { "chocolate cake", "ice cream", "pudding" };
	...
	String menu = ENTREES[entreeChoice] + ", " + SIDES[sideChoice1] + ", " + SIDES[sideChoice2] + ", and "
