...
public class CustomerItemOrder {
	...
	Path customers = Paths.get("C:\\Java\\Chapter.13\\Customers.txt");
	Path items = Paths.get("C:\\Java\\Chapter.13\\Items.txt");
	...
	try {
		...
		if (arrayC[0].equals("000"))
			...
			System.out.print(
				"Customer: " + arrayC[0] + "   Name: " + arrayC[1] + "   zip code: " + arrayC[2]);
