...
public class JCarlysCatering extends JFrame implements ItemListener, ActionListener {
	...
	if (source == guestsField) {
	    ...
	    output = "$" + price + " Menu includes " + entreeString + sideString + dessertString;
	...
	if (select == ItemEvent.SELECTED)
	    ...
	    else if (source == fishBox)
		entreeString = "- fish -";
	    else if (source == pastaBox)
		entreeString = "- pasta -";
	if (select == ItemEvent.SELECTED)
	    if (source == cakeBox)
		dessertString = "- chocolate cake -";
	    else if (source == pieBox)
		dessertString = "- apple pie -";
	    else if (source == pudBox)
